...
export const debugAssetManifest: AssetEntry[] = [
  ...
  },
  {
    ...
    src: `${import.meta.env.BASE_URL}pixel-editor/assets/tile_tree_16x16.png`,
    note: '픽셀 에디터 샘플 타일',
  },
  {
    id: 'grass-tile',
    ...
    src: `${import.meta.env.BASE_URL}pixel-editor/assets/tile_grass_16x16.png`,
  },
  {
    id: 'path-tile',
    group: 'tiles',
    label: 'Path Tile (editor)',
    src: `${import.meta.env.BASE_URL}pixel-editor/assets/tile_path_16x16.png`,
  },
  {
    id: 'water-tile',
    group: 'tiles',
    label: 'Water Tile (editor)',
    src: `${import.meta.env.BASE_URL}pixel-editor/assets/tile_water_16x16.png`,
  },
  {
    id: 'embercub',
    group: 'char',
    label: 'Embercub (editor monster)',
    src: `${import.meta.env.BASE_URL}pixel-editor/assets/monster_embercub_64x64.png`,
  },
  {
    id: 'leaflet',
    group: 'char',
    label: 'Leaflet (editor monster)',
    src: `${import.meta.env.BASE_URL}pixel-editor/assets/monster_leaflet_64x64.png`,
  },
  {
    id: 'aquapup',
    group: 'char',
    label: 'Aquapup (editor monster)',
    src: `${import.meta.env.BASE_URL}pixel-editor/assets/monster_aquapup_64x64.png`,
  },
  {
    id: 'og-opening',
    group: 'opening',
