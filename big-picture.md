...
## ORCH-037 Final Polish Checklist
- [x] 한국어 UI/전투 메시지 일관화 (Overworld/Battle/React HUD)
- [x] 모바일 조이스틱 터치 전용 입력(스크롤/텍스트 선택 방지)
- [x] 마을 서비스 위치 안내(상점/PC 타일 좌표 표기)
- [x] 풀숲 타일에서만 인카운터 발생하도록 조건 강화
- [x] 타일 시각 구분 강화(길/풀숲/벽 패턴)
- [x] Phaser 전투 캔버스 내 HP 바 UI 추가
- [ ] 후속: 전투 커맨드도 Phaser 캔버스 내부로 완전 이관
